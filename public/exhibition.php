...
?>
	...
	<div id="content" class="<?=$pageCode?>">
		<dl id="exhibitionArea">
			...
			<dd>
				<div class="sub-area1"><img src="../images/text_exhibition3.png" alt="함께 나누는 사진전에 초대합니다." /></div>
				<div class="sub-area2">
CCL(Creative Commons License)을 붙여 공유된 사진 100점을<br />
초대하여 만나보는 자리를 마련하였습니다.<br />
사진 속 다양한 삶의 이야기를 함께 나누시기를 바랍니다.<br />
				</div>
				<div class="sub-area3">
